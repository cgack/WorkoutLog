...
def _follow_log(path_info, chosen_device):
	...
	args = [path_info.adb, '-s', chosen_device, 'logcat', 'WebCore:D', 'Forge:D', '*:S']
	proc = Popen(args, stdout=sys.stdout, stderr=sys.stderr)
	proc.wait()
...
@task
def package_android(build, sdk, interactive=True, keystore=None, storepass=None, keyalias=None, keypass=None, **kw):
